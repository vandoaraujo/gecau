...
public class ControlaArea implements ActionListener  {
	...
	//static Logger logger = Logger.getLogger(ControlaArea.class);
	...
	public void habilitaTelaArea(){
		...
		// Preenche areas da tela
		areasInstanciadas = areaDao.listar3();
		//areaDao.fechaSession();
	...
	public void actionPerformed(ActionEvent eve) {
		...
		if(comando.equals("area")){
			//area getSelected - Buscar no Banco e popular a area
		...
		else if(comando.equals("insercao"))
		{
			...
			if(testa == true)
			{
				//Verificar lógica de passar a atribuicao para o controle principal
